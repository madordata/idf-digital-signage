...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  procedures: {
    ...
    card2: {
      ...
      intro: 'ממונת יוהל״ם ביחידה, קצינת הת״ש - 058-7303090',
      para3: 'יש לדווח על כל נושא חריג בנושא זה למפקד הישיר ולרנ״ג הפיקוד.',
    },
    card3: {
      para1: 'מידע צבאי מסווג לא יועבר בטלפון / בפקס האזרחי ו/או המטכ״לי.',
      para2: 'אין לחבר חיבור חיצוני למחשבים צבאיים (USB, וכו׳)',
      para3: 'אין להוציא מידע צבאי מחוץ לתחומי הבסיס ללא אישור ביטחון מידע.',
      para4: 'בסיום השירות במסמכים צבאיים, יש לגרוס ואין לזרוק לאשפה.',
      para5: 'אין להעלות פרטים מסווגים/צבאיים על גבי רשתות חברתיות.',
    },
  },
  ...
  safety: [
    ...
    },
    {
      ...
      footer: 'תדריך יציאה יתקיים לאחר מסדר בוקר',
    },
    {
      title: 'נשיאת נשק',
